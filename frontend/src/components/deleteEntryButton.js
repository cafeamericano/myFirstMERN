...
class DeleteEntryButton extends Component {
  ...
  render() {
    return (
        <div style={background} onClick={this.props.onClick} className=""> {/*This is where the child component uses its inherited method; when this div is clicked, handleClick is performed on the parent component*/}
